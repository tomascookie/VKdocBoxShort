...
import ru.brainix.ept.vkbox.docs.functions.DocEdit;


public class DocOptionsWindow {
    ...
    //Конструктор класса
   public DocOptionsWindow(String titleDoc, String sizeDoc, String dateDoc, String fileTypeDoc, String ownerId, String docId, String urlDoc){
    ...
    public void getPopUp(final View view) {
        ...
        buttonDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                docDownload.docDownload(urlDoc, view.getContext());
        ...
        buttonShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                docUrl.docCopy(urlDoc, view.getContext());
            }
        });
