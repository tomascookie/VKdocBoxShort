...
import ru.brainix.ept.vkbox.docs.functions.DocUpload;

public class DocUploadWindow {
                ...
                new ChooserDialog(view.getContext())
                        ...
                        .withChosenListener(new ChooserDialog.Result() {
                            ...
                            public void onChoosePath(String path, File pathFile) {
                                ...
                                buttonUpload.setText(R.string.buttonText_upload);
        ...
        buttonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(uploadableFile!=null) {
                    ...
                    docUpload.ups(uploadableFile, finalFileName,view.getContext());
